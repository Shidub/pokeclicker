...
ItemList['Fire_egg']     = new EggItem(GameConstants.EggItemType.Fire_egg, 1, undefined, 'Fire Egg');
ItemList['Water_egg']    = new EggItem(GameConstants.EggItemType.Water_egg, 1, undefined, 'Water Egg');
ItemList['Grass_egg']    = new EggItem(GameConstants.EggItemType.Grass_egg, 1, undefined, 'Grass Egg');
ItemList['Fighting_egg'] = new EggItem(GameConstants.EggItemType.Fighting_egg, -10, undefined, 'Fighting Egg');
ItemList['Electric_egg'] = new EggItem(GameConstants.EggItemType.Electric_egg, 1, undefined, 'Electric Egg');
ItemList['Dragon_egg']   = new EggItem(GameConstants.EggItemType.Dragon_egg, 1, undefined, 'Dragon Egg');
